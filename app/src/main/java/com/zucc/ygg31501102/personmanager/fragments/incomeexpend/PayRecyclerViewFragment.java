...
public class PayRecyclerViewFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(new RecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onLongClick(final int position) {
                ...
                dialog.show();
                Toast.makeText(getActivity(),"Tabbed on the line "+position,Toast.LENGTH_SHORT).show();
            }
        });
        return view;
    }
    ...
    public Date longToDate(long intDate){
        ...
        try {
            ...
            Toast.makeText(getActivity(),"Time converting error",Toast.LENGTH_SHORT).show();
            return null;
        }
        return date;
    }
