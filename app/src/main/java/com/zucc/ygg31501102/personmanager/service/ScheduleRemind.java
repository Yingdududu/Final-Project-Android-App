...
public class ScheduleRemind extends Service {
    ...
    public IBinder onBind(Intent intent) {
        Toast.makeText(getApplicationContext(),"Turn on schedule reminder",Toast.LENGTH_SHORT).show();
        return binder;
    }
...
//        Bitmap bitmap;
        ...
        Handler handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                try {
                    ...
                    looperEndSchedule();
                    Toast.makeText(getApplicationContext(),"Fixed time reminder",Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        public void Timer() {
            Toast.makeText(getApplicationContext(),"remindBinder has been used",Toast.LENGTH_SHORT).show();
            task = new TimerTask() {
                @Override
                public void run() {
                    // TODO Auto-generated method stub
