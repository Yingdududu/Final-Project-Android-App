        ...
        addScheduleButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    ...
                    Toast.makeText(getApplicationContext(),"Failed to add a schedule",Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onRequestPermissionsResult(int requestCode,String[] permissions, int[] grantResults) {
        ...
        switch(requestCode) {
            ...
            if(grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                // 没有获取到权限，做特殊处理
                Toast.makeText(this,"No permission to use GPS",Toast.LENGTH_SHORT).show();
            }
            break;
            default:
                break;
            ...
            public void onLocationChanged(AMapLocation aMapLocation) {
                if (aMapLocation != null) {
                    if (aMapLocation.getErrorCode() == 0) {
                        ...
                        Toast.makeText(getApplicationContext(),"Please open GPS",Toast.LENGTH_SHORT).show();
...
//        mLocationClient.onDestroy();//销毁定位客户端，同时销毁本地定位服务。
    ...
    public void addSchedule(){
        ...
        if (longEndDate < longStartDate){
            Toast.makeText(this,"Starting time cannot be later than ending time",Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    public Date StringToDate(String strDate){
        ...
        try {
            ...
            Toast.makeText(this,"Time format is invalid",Toast.LENGTH_SHORT).show();
            return null;
        }
        return date;
    }
